...
If you haven't read about how Flux works yet, start with the [What is Flux?](/guide/introduction/) page to see how it differs from traditional Luau UI libraries.
